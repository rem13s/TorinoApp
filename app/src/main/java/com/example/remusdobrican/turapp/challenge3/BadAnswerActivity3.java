...
import com.example.remusdobrican.turapp.challenge4.Challenge4Activity;
...
public class BadAnswerActivity3 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bad_answer_challenge3);
    ...
    // nextChallenge -> Challenge4Activity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_bad_answer_challenge3, menu);
        return true;
    }
