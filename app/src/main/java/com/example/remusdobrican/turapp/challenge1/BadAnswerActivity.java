...
public class BadAnswerActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bad_answer_challenge1);
    ...
    // nextChallenge -> Challenge2Activity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_bad_answer_challenge1, menu);
        return true;
    }
